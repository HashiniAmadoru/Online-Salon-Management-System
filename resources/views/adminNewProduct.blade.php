                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <p>
                                    <a href="{{ route('NewProduct_approve', ['product_id' => $data->product_id ]) }}" class="btn btn-primary"> Accept</a> &nbsp<a href="{{ route('NewProduct_delete', ['product_id' => $data->product_id ]) }}" class="btn btn-danger"> Reject</a></p></td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
